    ...
    def video_demo(self):
        ...
        while True:
            ...
            try:
                ...
                cv2.rectangle(frame, (1, 1), (220, 25),
                              (223, 128, 255), cv2.FILLED)
                cv2.putText(frame, f"press q to exit", (20, 20),
    ...
    def detect_faces(self, frame):
        ...
        for i in range(0, faces.shape[2]):
            ...
            if confidence < 0.5:
                continue
            xmin, ymin, xmax, ymax = (
                faces[0, 0, i, 3:7] * np.array([w, h, w, h])).astype("int")
    ...
    def detect_emotion_for_single_frame(self, frame):
        ...
        for face in face_results:
            ...
            if face_image.shape[0] < 10 or face_image.shape[1] < 10:
                continue
            emo_label, emo_proba, proba_list = self.detect_emotion_for_single_face_image(
                face_image)
